...
| POSTGRESQL_URL | connection url to the database | postgresql://admin:admin@localhost:55432/amplication |
...
| PORT | the post that the server is running on | 53000 |
| HOST | localhost | http://localhost:53000 |
